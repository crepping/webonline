...
$salida ="";
$query ="select r.id_reserva,c.rut,c.nombres,c.apellidos,c.telefono,v.patente,r.fecha_reserv,r.Hora,r.ingreso_fecha from reserva r,cliente c, vehiculo v where r.id_cliente = r.id_cliente and c.id_cliente = r.id_cliente and r.id_cliente = v.id_vehiculo and r.estado_reserva =3";
