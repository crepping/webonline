  ...
  <div class="modal fade" id="Ingreso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="col-sm-6">
                    <input type="text" class="form-control form-control-user" id="codigo1" name="codigo">
                 </div>
                 <BR>
                 <BR>
  ...
  <div class="modal fade" id="Ingreso1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form method="POST" id="reserva2"  onsubmit="event.preventDefault(); sendDataProduct1();">
        <div class="col-sm-6">
                  <input type="hidden" class="form-control form-control-user" id="codigo2" name="borrar">   
        </div>
                 <BR>
                 <BR>
                 <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
